...
public class Inputter {
    ...
    //hàm nhập số nguyên dương, cho phép bỏ trống (Enter) để giữ nguyên giá trị cũ -> trả về null
    public static Integer getAnPositiveIntegerOptional(String inputMessage, String errorMessage){
        while(true){
            System.out.println(inputMessage);
    ...
    //hàm ép nhập Y/N (không phân biệt hoa thường), chỉ chấp nhận Y hoặc N
    public static boolean getYesNo(String inputMessage, String errorMessage){
        while(true){
            System.out.println(inputMessage);
